...
WHERE cn1_1.country_code != '[us]'
  ...
  AND kt2_1.kind IN ('tv series',
                     'episode')
  AND lt_1.link IN ('sequel',
                    'follows',
                    'followed by')
  AND mi_idx2_1.info < '3.5'
  AND t2_1.production_year BETWEEN 2000 AND 2010
  ...
  AND kt2_2.kind IN ('tv series',
                     'episode')
  AND lt_2.link IN ('sequel',
                    'follows',
                    'followed by')
  AND mi_idx2_2.info < '3.5'
  AND t2_2.production_year BETWEEN 2000 AND 2010
