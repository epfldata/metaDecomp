SELECT at_1.title AS aka_title_1,
       t_1.title AS internet_movie_title_1,
       at_2.title AS aka_title_2,
       t_2.title AS internet_movie_title_2
