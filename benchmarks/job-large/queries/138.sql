...
WHERE cct1_1.kind IN ('cast',
  ...
  AND (t_1.title LIKE '%Freddy%'
       OR t_1.title LIKE '%Jason%'
       OR t_1.title LIKE 'Saw%')
  ...
  AND (t_2.title LIKE '%Freddy%'
       OR t_2.title LIKE '%Jason%'
       OR t_2.title LIKE 'Saw%')
