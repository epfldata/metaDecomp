SELECT cn_1.name, mi_idx_1.info, t_1.title, cn_2.name, mi_idx_2.info, t_2.title
...
GROUP BY cn_1.name, mi_idx_1.info, t_1.title, cn_2.name, mi_idx_2.info, t_2.title;