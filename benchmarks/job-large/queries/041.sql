SELECT cn_1.name AS company_name_1,
       ...
       t_1.title AS western_follow_up_1,
       cn_2.name AS company_name_2,
       lt_2.link AS link_type_2,
       t_2.title AS western_follow_up_2
...
WHERE cn_1.country_code !='[pl]'
  ...
  AND mi_1.info IN ('Sweden',
                    ...
                    'German',
                    'English')
  AND t_1.production_year BETWEEN 1950 AND 2010
  ...
  AND mi_2.info IN ('Sweden',
                    ...
                    'German',
                    'English')
  AND t_2.production_year BETWEEN 1950 AND 2010
