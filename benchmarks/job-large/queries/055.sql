SELECT mi_idx_1.info AS rating_1,
       t_1.title AS western_dark_production_1,
       mi_idx_2.info AS rating_2,
       t_2.title AS western_dark_production_2
...
WHERE it1_1.info = 'countries'
  ...
  AND mi_1.info IN ('Sweden',
                    ...
                    'USA',
                    'American')
  AND mi_idx_1.info > '6.0'
  AND t_1.production_year > 2010
  AND (t_1.title LIKE '%murder%'
       OR t_1.title LIKE '%Murder%'
       OR t_1.title LIKE '%Mord%')
  ...
  AND mi_2.info IN ('Sweden',
                    ...
                    'USA',
                    'American')
  AND mi_idx_2.info > '6.0'
  AND t_2.production_year > 2010
  AND (t_2.title LIKE '%murder%'
       OR t_2.title LIKE '%Murder%'
       OR t_2.title LIKE '%Mord%')
