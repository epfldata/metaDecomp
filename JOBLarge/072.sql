SELECT mi_idx_1.info, t_1.title, t2_2.title, cn2_2.name, cn1_2.name, mi_idx2_2.info, t1_2.title, mi_idx1_2.info
...
WHERE it1_1.info = 'countries'
  ...
  AND mi_idx_1.info = mi_idx2_2.info
GROUP BY mi_idx_1.info, t_1.title, t2_2.title, cn2_2.name, cn1_2.name, mi_idx2_2.info, t1_2.title, mi_idx1_2.info;