SELECT chn_1.name, mi_idx_1.info, n_1.name, t_1.title, cn_2.name, mi_idx_2.info, t_2.title
FROM char_name AS chn_1,
    ...
    comp_cast_type AS cct2_1, title AS t_2,
    kind_type AS kt_2,
...
GROUP BY chn_1.name, mi_idx_1.info, n_1.name, t_1.title, cn_2.name, mi_idx_2.info, t_2.title;